...
from sphero_unsw.commands.animatronic import Animatronic
...
from sphero_unsw.controls.v2 import DriveControl, LedControl, SensorControl, FirmwareUpdateControl, StatsControl
from sphero_unsw.toy import ToyV2, ToySensor, Toy
